...
public class IpDoc2 {
	...
	public IpDoc2(Long id, Integer createdBy, Integer diligenceId, String fileName, String filePath, String fileType) {
		super();
		this.id = id;
	...
	public String toString() {
		return "IpDoc2 [id=" + id + ", createdBy=" + createdBy + ", diligenceId=" + diligenceId + ", fileName="
